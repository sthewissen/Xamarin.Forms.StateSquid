...
namespace Xamarin.Forms.StateSquid
{
    public static class StateLayout
    {
        ...
        public static readonly BindableProperty AnimateStateChangesProperty = BindableProperty.CreateAttached("AnimateStateChanges", typeof(bool), typeof(Layout<View>), true, propertyChanged: (b, o, n) => ((BindableObject)b).SetValue(AnimateStateChangesProperty, n));
